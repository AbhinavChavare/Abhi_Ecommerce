      ...
      <div className='container'>
        ...
        <div className=' cont-form '>
          <form  className='conformwid  flex-column-center'action='https://formspree.io/f/meqdwlpe' method="POST">
            <input  className='conformwid'   type={"text"} name="UserName" placeholder="Usernamer" required autoComplete='off'></input>

            <input className='conformwid' type={"email"} name="Email" placeholder="Email" required autoComplete='off'></input>
